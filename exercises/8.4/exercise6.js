...
class BankTransaction {
  static transfer (a, b, c) {
    const origem = BankAccount.withdrawal(a);
    const destino = BankAccount.deposit(b);
    const valor = BankAccount.balance;
  }
}
...
assert.equal(typeof BankAccount.prototype, "object")
assert.ok(account2 instanceof BankAccount) //ok
